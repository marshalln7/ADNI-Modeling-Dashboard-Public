...
def merge_progression_variables():
    ...
    raw_files_list = os.listdir(working_directory + r"/Datasets/Raw Data Files")
    ...
    progression_variables = pd.read_excel(r"Datasets/Progression Variables.xlsx")
    ...
    merged_dataframe = pd.read_csv(r"Datasets\Raw Data Files\REGISTRY - Registry [ADNI1,GO,2,3].csv")
