...
#raw_data = pd.read_csv("Datasets/Raw Data Files/UCSFFSX51 - UCSF - ADNI-1 3T Cross-Sectional FreeSurfer (5.1) [ADNI1].csv")
raw_data = pd.read_csv("Datasets/Raw Data Files/UCSFFSX7 - UCSF - Cross-Sectional FreeSurfer (7.x) [ADNI1,GO,2,3,4].csv")
...
new_filename = "Freesurfer Variables " + date_string + ".xlsx"
