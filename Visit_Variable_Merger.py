...
def merge_visit_variables():
    ...
    visit_variables = pd.read_excel("Datasets/Visit Variables.xlsx")
    ...
    merged_dataframe.set_index(["RID", "VISCODE2", "PHASE"]).sort_index(inplace = True)
    ...
    merged_dataframe.set_index(["RID", "VISMONTH", "PHASE"], inplace=True)
