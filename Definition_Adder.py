...
nice_files_list = os.listdir(working_directory + "/Datasets/Labeled Data Files")

def clean_file(file):
    file_to_modify = "Datasets/Raw Data Files/" + file
    official_data_dictionary = pd.read_csv("Datasets/Official Data Dictionary.csv")
    scraped_data_dictionary = pd.read_excel("Datasets/Scraped Data Dictionary.xlsx")
    ...
    target_dataset.to_csv("Datasets/Labeled Data Files/" + file, na_rep='NaN')
